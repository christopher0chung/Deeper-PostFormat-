...
public class DebuggingTest : Deeper_Component {
    ...
    private void Update()
    {
        ...
        {
            Debug.Log(Deeper_ServicesLocator.instance.GetCharacter(ControllersEnum.C0));
        }
        ...
        for (int i = 0; i <= 1; i++)
        {
            ...
            //Debug.Log("Player " + i + " Swim Vertical is: " + players[i].GetAxis("Swim Vertical"));
            //Debug.Log("Player " + i + " Swim Horizontal is: " + players[i].GetAxis("Swim Horizontal"));
            //Debug.Log("Player " + i + " Light Vertical is: " + players[i].GetAxis("Light Vertical"));
            //Debug.Log("Player " + i + " Light Horizontal is: " + players[i].GetAxis("Light Horizontal"));
            //Debug.Log("Player " + i + " Player Action is: " + players[i].GetButtonDown("Player Action"));
            //Debug.Log("Player " + i + " Sub Vertical is: " + players[i].GetAxis("Sub Vertical"));
            //Debug.Log("Player " + i + " Sub Horizontal is: " + players[i].GetAxis("Sub Horizontal"));
            //Debug.Log("Player " + i + " Sub Light Vertical is: " + players[i].GetAxis("Sub Light Vertical"));
            //Debug.Log("Player " + i + " Sub Light Horizontal is: " + players[i].GetAxis("Sub Light Horizontal"));
            //Debug.Log("Player " + i + " Sub Egress is: " + players[i].GetButtonDown("Sub Egress"));
            //Debug.Log("Player " + i + " Dialogue Select is: " + players[i].GetButtonDown("Dialogue Select"));
        }
    }
}
